...
assign(3, 5, "M")    # M1 what is Kiro
assign(6, 8, "F")    # M2 vibe/chat
assign(9, 12, "M")   # M3 specs
assign(13, 15, "F")  # M4 steering
assign(16, 18, "M")  # M5 hooks
assign(19, 21, "F")  # M6 MCP
assign(22, 25, "M")  # M7 powers
assign(26, 29, "F")  # M8 adoption
